...
try "ROCm + SDKs installieren" bash -c "yes | sudo amdgpu-install --usecase=rocm,lrt,hip,opencl,mllib,graphics,rocmdevtools,hiplibsdk,openclsdk,openmpsdk,mlsdk --no-dkms --accept-eula"
