...
try "ROCm + SDKs installieren" bash -c "yes | sudo amdgpu-install --usecase=dkms,graphics,rocm,lrt,hip,opencl,mllib,graphics,rocmdevtools,hiplibsdk,openclsdk,openmpsdk,mlsdk --accept-eula"
